...
import { CreateAllianceButton } from './components/AllianceForm'
import { EditAllianceForm } from './components/EditAllianceForm'
  ...
  return (
    <main className="p-4 md:p-6 space-y-6 bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <CreateAllianceButton onCreate={(v) => crearMutation.mutate(v)} loading={crearMutation.isPending} />
      </div>
...
// CreateAlianzaButton is now imported from components/AllianceForm.tsx
...
// EditAlianzaDialog is now imported from components/EditAllianceForm.tsx

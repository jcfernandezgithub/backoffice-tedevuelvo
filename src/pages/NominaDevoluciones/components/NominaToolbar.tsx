...
import { Plus, Copy, Trash2, CheckCircle, FileDown, FileUp, Download, Loader2, Eraser, PlayCircle, Group } from 'lucide-react'
...
export function NominaToolbar({
  hasSelection, onAdd, onDuplicate, onRemove,
  onValidate, onGenerateNormal, onGenerateGrouped,
  onImportCsv, onDownloadTemplate, onLoadExample, onClear, rowCount,
}: Props) {
  return (
    <div className="flex flex-wrap gap-2">
      <Button size="sm" onClick={onAdd}><Plus className="mr-1 h-4 w-4" /> Agregar fila</Button>

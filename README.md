...
- La actualización se realiza mediante `PATCH /api/v1/refund-requests/:publicId/personal-information` antes de generar o subir el PDF, asegurando que el certificado refleje la información más reciente.
